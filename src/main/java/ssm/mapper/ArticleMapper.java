...
public interface ArticleMapper {
     ...
     * @return 数量
     */
    Integer countArticle(@Param(value = "articleStatus") String articleStatus);
     ...
     * @param articleStatus
     */
    Integer updateBatch(@Param("ids") List<String> ids, @Param("articleStatus") Integer articleStatus);
     ...
     * @return
     */
    Article getByArticleId(@Param("articleId") Integer articleId);
