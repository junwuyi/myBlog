...
import ssm.mapper.CommentMapper;
...
public class CommentServiceImpl implements CommentService {
    ...
    @Override
    @CacheEvict(value = "comments", allEntries = true, beforeInvocation = true)
    ...
    @Override
    @Cacheable(value = "comments", key = "'article_comment_'+#articleId")
    ...
    @Override
    @Cacheable(value = "comments", key = "'comment_'+#id")
     ...
     */
    @Override
    @Cacheable(value = "comments", key = "'comment_index_size_'+#pageIndex+'_'+#pageSize", unless = "#result == null")
    ...
    @Override
    @Cacheable(value = "comments", key = "'list_comment'")
    ...
    @Override
    @Cacheable(value = "comments", key = "'count_comment'")
    ...
    @Override
    @Cacheable(value = "comments", key = "'list_recent_comment_'+#limit")
    ...
    @Override
    @Cacheable(value = "comments", key = "'list_child_comment_'+#id")
